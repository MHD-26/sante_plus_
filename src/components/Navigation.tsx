...
export default function Navigation({
  ...
  const principalItems = [
    ...
    {
      id: "rendezvous",
      label: "Rendez-vous & Rappels",
      icon: Calendar,
      roles: [UserRole.ADMIN, UserRole.ACCUEIL, UserRole.MEDECIN, UserRole.DIRECTION],
    },
    {
      id: "patients",
  ...
  const operationsItems = [
    ...
    {
      id: "complaints",
      label: "Plaintes & Satisfaction",
      icon: Frown,
      roles: [UserRole.ADMIN, UserRole.DIRECTION, UserRole.ACCUEIL],
    },
    {
      id: "assistantia",
      label: "Assistant IA Clinique",
      icon: Sparkles,
      roles: Object.values(UserRole),
    },
    {
      id: "procedures",
      label: "Procédures & Aide",
      icon: BookOpen,
      roles: Object.values(UserRole),
    },
    {
      id: "settings",
      label: "Sauvegarde & Paramètres",
      icon: Settings,
  ...
  return (
    <>
      ...
      <header
        className="lg:hidden h-16 bg-[#065f46] text-white flex items-center justify-between px-4 sticky top-0 z-50 border-b border-[#047857]"
      ...
      {mobileMenuOpen && (
        <div
          className="lg:hidden fixed inset-0 top-16 bg-[#065f46] z-40 flex flex-col p-4 space-y-4 overflow-y-auto border-t border-[#047857] animate-fade-in"
        ...
        >
          ...
          {/* Role Switcher (uniquement pour le mode dev non authentifié) */}
          {!userFullName && (
            <div className="bg-[#054b38] p-3 rounded-lg border border-[#047857] space-y-2">
              <div className="flex justify-between items-center text-xs text-emerald-200">
                ...
                <span
                  className={`px-2 py-0.5 rounded border text-[10px] font-bold uppercase ${getRoleBadgeClass(currentUserRole)}`}
                >
                  {currentUserRole}
                </span>
              </div>
          ...
          <div className="space-y-1">
            <div className="px-2 py-1 text-[10px] font-bold text-emerald-300 uppercase tracking-wider">
              Principal
            </div>
      ...
      <aside
        className="hidden lg:flex w-64 bg-[#065f46] flex-col h-screen sticky top-0 shrink-0 border-r border-[#047857]"
        id="desktop-sidebar"
      >
        {/* Brand Header */}
        <div className="p-5 flex items-center gap-3 border-b border-[#047857] shrink-0">
          ...
          <div>
            ...
            <span className="text-[10px] text-emerald-300 font-mono tracking-wider block mt-0.5">
              PORTAIL CLINIQUE
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-4 px-3 space-y-5">
          {/* Principal Category */}
          <div className="space-y-1">
            <div className="px-3 mb-1.5 text-[10px] font-extrabold text-emerald-300 uppercase tracking-wider">
              Principal
            </div>
            {renderNavList(principalItems)}
          </div>
        ...
        <div className="p-4 bg-[#054b38] border-t border-[#047857] shrink-0 space-y-3">
          ...
          {userFullName ? (
            ...
            <div className="relative">
              ...
              >
                <span className="truncate text-left text-emerald-200">
                  Session : <strong className="text-white">{currentUserRole}</strong>
                </span>
          ...
          <div className="flex items-center justify-between pt-1">
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${isOnline ? "bg-emerald-400 animate-pulse" : "bg-amber-400 animate-pulse"}`}
              ></div>
